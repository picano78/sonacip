...
legacy_bp.add_url_rule('/', 'legacy_root', lambda: redirect('/field_planner/', code=302))
legacy_bp.add_url_rule('/<path:subpath>', 'legacy_redirect', lambda subpath: redirect(f'/field_planner/{subpath}', code=302))
