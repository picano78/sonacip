...
'''
    ...
    try:
        ...
        # Also create login.html if missing
...
'''
        ...
        login_file = f'{templates_dir}/login.html'
...
chmod +x fix_register_society_404.py
print_success "Register society 404 fix script created"
