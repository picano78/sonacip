...
def fix_register_society_route():
    ...
    try:
        ...
        if '@bp.route(\'/register-society\'' in content:
            print("Route /register-society already exists")
            return True
...
'''
        ...
        print("Route /register-society alias added successfully")
        return True
...
{% block title %}Registra Societa - SONACIP{% endblock %}
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center">Registra Societa Sportiva</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ url_for('auth.register_society') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="company_name" class="form-label">Nome Societa *</label>
                                ...
                                <div class="mb-3">
                                    <label for="company_type" class="form-label">Tipo Societa *</label>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">Registra Societa</button>
                        </div>
                    </form>
                    
                    <div class="text-center mt-3">
                        <p>Hai gia un account? <a href="{{ url_for('auth.login') }}">Accedi</a></p>
